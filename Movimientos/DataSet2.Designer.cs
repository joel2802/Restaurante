...
namespace Restaurante.Movimientos {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class PedidosDataTable : global::System.Data.TypedTableBase<PedidosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PedidosRow AddPedidosRow(string NombreCliente, decimal Subtotal, decimal Impuesto, decimal Total, string Usuario) {
        ...
        public partial class PedidosRow : global::System.Data.DataRow {
            ...
            public decimal Impuesto {
                get {
                    return ((decimal)(this[this.tablePedidos.ImpuestoColumn]));
                }
                set {
                    this[this.tablePedidos.ImpuestoColumn] = value;
                }
            }
...
namespace Restaurante.Movimientos.DataSet2TableAdapters {
...
WHERE MONTH(p.Fecha) = @mes AND YEAR(p.Fecha) = @año";
        ...
        public virtual int Fill(DataSet2.PedidosDataTable dataTable, decimal mes, decimal año) {
        ...
        public virtual DataSet2.PedidosDataTable GetData(decimal mes, decimal año) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(mes));
            this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(año));
            DataSet2.PedidosDataTable dataTable = new DataSet2.PedidosDataTable();
